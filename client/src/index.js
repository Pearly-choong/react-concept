...
const headings =(
  <div>
    <h1>Learning more react concept</h1>
    <h2>more tags can go inside the parent container, must be enclose within parentheses</h2>
  </div>
)
...
class Displayheadings extends React.Component{
  render(){
    return (
      <div>
        <h1>Learning more react concept from Displayheadings class component</h1>
        <h2>more tags can go inside the parent container, must be enclose within parentheses</h2>
      </div>
...
// }
//
// ReactDOM.render(<Displayheadings />,document.getElementById('root3'));
...
class Displayname extends React.Component{
  render(){
    return (
      <div>
        <h1>Hi, {this.props.name} Learning more react concepts from Displaheading class component</h1>
        <h2>more tage go inside the parent container, must be enclosed within parentheses</h2>
      </div>
    )
  }
}
...
ReactDOM.render(<Mystate name="Daniel" age="43"/>,document.getElementById('root5'));
